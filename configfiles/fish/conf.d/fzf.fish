set -q FZF_TMUX_HEIGHT; or set -U FZF_TMUX_HEIGHT "80%"
set -q FZF_DEFAULT_OPTS; or set -U FZF_DEFAULT_OPTS "--height $FZF_TMUX_HEIGHT --reverse --border"
...
set -q FZF_DEFAULT_COMMAND; or set -U FZF_DEFAULT_COMMAND 'rg --files --hidden --glob "!.git"'
set -q FZF_FIND_FILE_OPTS; or set -U FZF_FIND_FILE_OPTS "--preview 'bat --style=numbers --color=always --line-range :500 {}'"
